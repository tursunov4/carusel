...
export default function VeneerContent({ data }: { data: Treatment }) {
    ...
    data.doctors = [
      {
        ...
        years: 12,
        image: {
          image: "/images/dummy/doctors/photo-1.jpg",
          id: 1,
          is_main: true,
        },
        category: [{ name: "ортопедия", color: "lightgray" }],
        specialties: [
      ...
      },
      {
        ...
        years: 23,
        image: {
          image: "/images/dummy/doctors/photo-2.jpg",
          id: 2,
          is_main: false,
        },
        category: [{ name: "ревматология", color: "lightblue" }],
        specialties: [
      ...
      },
      {
        ...
        years: 34,
        image: {
          image: "/images/dummy/doctors/photo-3.jpg",
          id: 3,
          is_main: false,
        },
        category: [{ name: "ортопедия", color: "lightgreen" }],
        specialties: [
          "Доктор медицинских наук Университета Ханянг",
            ...
            links={[
              {
                isLast: false,
                label: "Стоматология",
                href: "/treatment/stomatology_in_china",
              },
          ...
          <SinglePageParentSection onClick={() => openModal(1)}>
            <div className="flex flex-row gap-12 flex-wrap">
              <div className="flex flex-col gap-12 flex-1 justify-between">
                <div>
                  <h4 className="fnt-h4">
                    Надёжная эстетика премиум-класса — по международным
                    протоколам и с корейской точностью
                  </h4>
                </div>
                <div className="fnt-notes">
                  <p>
                    Donec aliquam felis et libero scelerisque, at imperdiet
                    justo sagittis. Donec accumsan convallis lorem, vel feugiat
                    tellus eleifend sed. Duis non porttitor mauris, a suscipit
                    odio.
                  </p>
                  <p>
                    Donec accumsan convallis lorem, vel feugiat tellus eleifend
                    sed. Duis non porttitor mauris, a suscipit odio.{" "}
                  </p>
                </div>
                <Button>Запись на консультацию</Button>
              </div>
              <div className="flex-1">
                <img src="/images/dummy/treatment/section-veneer.jpg" alt="" />
              </div>
            </div>
          </SinglePageParentSection>
