...
export default function VeneerContent({data}: { data: Treatment }) {
    ...
    return (
        <div className="single-page treatment">
                    ...
                    <SinglePageParentSection onClick={() => openModal(1)}>
                        <div className="flex flex-row gap-12 flex-wrap">
                            <div className="flex flex-col gap-12 flex-1 justify-between">
                                <div>
                                    <h4 className="fnt-h4">Надёжная эстетика премиум-класса — по международным
                                        протоколам и с корейской
                                        точностью</h4>
                                </div>
            ...
            <MobileFloatingBookButton page="Виниры" buttonText="Консультация" infoText={data.title}/>
        </div>
    );
}
