...
const cardsTooth = [
    ...
    },
    {
        ...
        text: "Для людей с малым количеством зубов или их отсутствием. Либо, если у пациента слишком слабые кости в" +
            " деснах",
        link: "/treatment/crowns",
    },
    {
        id: 3,
        title: "Импланты",
    ...
    },
    {
        ...
        text: "Зубные коронки могут не только восполнить недостающие зубы, но и значительно улучшить вид зубов",
        link: "/treatment/veneers",
    },
]

export default function StomatologiyaContent({data}: { data: Treatment }) {
        ...
        <div className="single-page treatment">
            ...
            <Container className="sides">
                <div id="description" className="left-side">
                    <div className="stomatologiya-hero">
                        <div className="image-block">
                            <img src={data.header_image ?? "/images/dummy/Cover.jpg"} alt="стоматология" width="100%"
                                 height="100%"
                        ...
                        <div className="content-part">
                            ...
                            <div className="cards-tooth">
                                {cardsTooth && cardsTooth.map(item => (
                                    <div key={item.id} className="header-card">
                                        <Link href={item.link}>
                    ...
                    <div id="services" className="flex flex-col gap-12">
                        ...
                        <div className="cards flex flex-col gap-24">
                            <div className="uslugi">
                                {cardsTooth && cardsTooth.map(item => (
                                    <div key={item.id} className="usluga">
                                        <BaseCard className="content-part">
                                            ...
                                            <Link href={item.link} className="btn btn-orange btn-primary">Узнать
                                                больше</Link>
                                        </BaseCard>
                                        <div className="image-block">
                    ...
                    <SinglePageParentSection id="choose-hotel">
                        <div className="flex flex-row justify-between mb-4">
                            ...
                            <Link href="/media/hospitals" className="btn btn-orange btn-primary">Перейти к
                                клиникам</Link>
                        </div>
            ...
            <MobileFloatingBookButton page="Стоматология" buttonText="Консультация" infoText={data.title}/>
        </div>
    );
}
