...
export default function TreatmentContent({data}: { data: Treatment }) {
    ...
    return (
        <div className="single-page treatment">
                ...
                <div id="description" className="left-side">
                    <div style={{
                        ...
                        <div style={{position: "absolute", width: "100%", height: "100%", zIndex: 1}}>
                            <img src="/images/dummy/Cover.jpg" alt="стоматология" width="100%" height="100%"
                        ...
                        <div className="flex flex-col gap-12 justify-between"
                            ...
                            <div className="flex flex-col gap-12" style={{color: 'white'}}>
                                <div className="fnt-h2" style={{color: 'white'}}>Лечение и протезирование зубов в
                                    Хуньчуне
                                </div>
                                <div>Совместите лечение зубов с путешествием во время стоматологического тура в
                                    Хуньчунь
                                </div>
                                <Button style={{width: 'fit-content', marginTop: 30}}>Узнать стоимость тура</Button>
                            </div>
                            <div className="flex flex-row gap-24" style={{justifyContent: 'space-evenly'}}>
                                {toothVariants && toothVariants.map(item => (
                                    <div key={item.text} className="header-card">
                                        <Link href="#">
                                            <span className="price headline">{item.price}</span>
                                            <div className="text fnt-notes c-black-subheading">{item.text}</div>
                                        </Link>
                    ...
                    <SinglePageParentSection>
                        <p>
                            Здоровые зубы — залог комфорта и правильной работы всего организма. Но если возникают
                            проблемы, часто приходится прибегать к протезированию, имплантации или установке коронок.
                        </p>
                        <p>
                            Сегодня многие россияне выбирают стоматологические туры в Китай, особенно в приграничный
                            город Хуньчунь. Здесь стоматология совмещается с путешествием: за 4-5 дней можно
                            восстановить зубы, отдохнуть, познакомиться с другой культурой и попробовать местную кухню.
                        </p>
                    </SinglePageParentSection>


                    <SinglePageParentSection id="about" title="Почему Хуньчунь так популярен у россиян?">
                        <div className="includes-list col w-100">
                            {treatIncludes && treatIncludes.map((item: InfoBlock, index) => (
                    ...
                    <div id="services" className="flex flex-col gap-12">
                        ...
                        <p>Главное отличие лечения зубов в Хуньчуне — цена и скорость. За 4-5 дней можно пройти все
                            процедуры и одновременно насладиться поездкой: познакомиться с культурой, попробовать кухню
                            и совместить лечение с отдыхом</p>

                        <div className="cards flex flex-col gap-24">
                            {cardsTooth && cardsTooth.map(item => (
                                <div key={item.id} className="uslugi">
                                    <div className="usluga flex flex-row gap-2">
                                        <BaseCard className="flex-1 flex flex-col gap-24 justify-center">
                                            ...
                                            <div className="fnt-notes c-black-subheading">{item.price}</div>
                    ...
                    <SinglePageParentSection id="choose-hotel">
                        <div className="flex flex-row justify-between mb-4">
                            ...
                            <Link href="/media/hospitals" className="btn btn-orange btn-primary">Перейти к клиникам</Link>
                        </div>
                        <p className="mb-3">Нажав на кнопку, вы сможете увидеть полный список клиник в Хуньчуне. При
                            выборе медицинского
                            учреждения обратите внимание на:</p>
                        <ul>

                            <li>Отзывы — ищите разные источники, а не только положительные комментарии;</li>
                            <li>Консультацию с организаторами тура — их опыт и рекомендации помогут подобрать
                                оптимальный вариант;
                            </li>
                            <li>Личный опыт знакомых. По статистике 23% россиян выбирают Китай, возможно, кто-то из
                                ваших друзей уже проходил там лечение
                            </li>


                        </ul>
                    </SinglePageParentSection>
                    <SinglePageParentSection id="how-it-works" title="Как проходит поездка?">
                        ...
                        <SinglePageNestedSection borderBottom>
                            ...
                            <ul>
                                <li>Если у человека перед поездкой подготовлена ротовая полость и отсутствует
                                    необходимость
                                    лечения,
                                    второй день пациент может проводить по своему усмотрению — прогулки, магазины, кафе,
                                    экскурсии
                                </li>
                            </ul>
                        </SinglePageNestedSection>
                        ...
                        <SinglePageNestedSection borderBottom>
                            ...
                            <ul>
                                ...
                                <li>Пациенту дают время, чтобы он мог походить и проверить, как зафиксированы новые
                                    зубы;
                                </li>
                                <li>Если нет дискомфорта, ничего не мешает и не трёт, зубы фиксируют на постоянный
                                    клей
                                </li>
                            </ul>
                        </SinglePageNestedSection>
                        ...
                        <SinglePageNestedSection>
                            ...
                            <ul>
                                <li>Если на 4 день у пациента не появились жалобы, то мы возвращаемся домой. Выезд из
                                    Китая
                                    в
                                    10:30,
                                    время прибытия во Владивосток 20:00;
                                </li>
                                <li>Если имеются жалобы, то мы идём в клинику в 8 утра и исправляем недочёты. Выезд из
                                    Китая
                                    в
                                    12:30,
                                    время прибытия во Владивосток в 21:30
                                </li>
                            </ul>
                        </SinglePageNestedSection>
            ...
            <MobileFloatingBookButton page="Лечение" buttonText="Консультация" infoText={data.title}/>
        </div>
    );
}
