...
export default function ExcursionsSidebar({isCollapsed = false}: { isCollapsed?: boolean }) {

    return (
        <aside className={`sidebar${isCollapsed ? ' collapse' : ''}`}>
            {/* todo объединить в компонент sidebar */}
            <BaseCard className="sidebar-content no-bottom-header scrollable">
