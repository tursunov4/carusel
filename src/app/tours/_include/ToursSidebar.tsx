...
export default function ToursSidebar() {
    return (
        <aside className="sidebar">
            ...
            <BaseCard className="sidebar-content no-bottom-header scrollable" mobileCardHeader="Фильтры" isExpanded={false}>
                <div className="filters">

                    {/* todo get filters from DB */}
                    {/* todo loop через блоки фильтров, внутри сами фильтры */}
                    <div className="sidebar-item filters-block main-item">
                        ...
                        <div className="filters-list">
                            ...
                            <div className="filter-item">
                                <label>
                                    <input type="checkbox"/>
                                    <Image className="checkmark" src={checkmarkIcon} alt="отметка фильтра" width={16}
                                           height={17}/>
                                    Все
                                </label>
                            </div>
                            ...
                            {fakeFiltersClass.filters && fakeFiltersClass.filters.map((filter) => (
                                <div key={filter.id} className="filter-item">
                                    <label>
                                        <input type="checkbox"/>
                                        <Image className="checkmark" src={checkmarkIcon} alt="отметка фильтра"
                                               width={16} height={17}/>
                                        {filter.name}
                                    </label>
                                </div>
                                ...
                                <div key={filter.id} className="filter-item">
                                    <label>
                                        ...
                                        <div className="checkmark">
                                            <Image src={checkmarkIcon} alt="отметка фильтра" width={16} height={17}/>
                                        </div>
                                        {filter.name}
                                    </label>
                                </div>
